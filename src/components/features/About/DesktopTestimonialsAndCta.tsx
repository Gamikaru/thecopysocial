// src/components/features/About/DesktopTestimonialsAndCta.tsx
"use client";
...
const DesktopTestimonialsAndCta: React.FC<TestimonialsAndCtaProps> = ({
  testimonials,
}) => {
...
export default DesktopTestimonialsAndCta;